  ...
  <Layout>
         ...
         <div id="particles-container-second">
            <div class="nem-main-header">
                        ...
                        <p class="uk-text-center">{{ $page.category.title }} tips & tricks</p>
        ...
        <div
          ...
          <div uk-grid>
            ...
            <aside class="uk-width-1-1 uk-width-1-4@s uk-width-1-4@m uk-width-1-5@l uk-width-1-5@xl uk-first-column">
              ...
              <h2 class="uk-heading-bullet">{{ $page.category.title }}</h2>
              ...
              <div class="uk-width-4-5@m uk-width-4-5@l uk-width-4-5@xl">
                <section class="uk-section uk-padding-remove-top">
                  ...
                  >
                    ...
                    <Pager class="nem-pagination" :info="$page.category.belongsTo.pageInfo"/>
...
export default {
 ...
 metaInfo () {
    return {
      title: 'Frontend War - ' + this.$page.category.title,
    }
  }
};
</script>
